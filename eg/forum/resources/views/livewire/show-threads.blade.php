    ...
    <div class="w-64">
        ...
        <ul>
            @foreach ($categories as $category)
                <li class="mb-2">
                    {{-- filtrado de las categorias con el metodo del componente filterByCategory($category)
                    escucha un evento de clic, el modificador prevent se evita que la pagina recargue (se evita la accion predeterminada de HTML, si existe) --}}
                    ...
                    <div class="w-full">
                        ...
                        <p class="flex items-center justify-between w-full text-xs">
                            ...
                            <span class="flex items-center gap-1 text-slate-700">
                                ...
                                @can('update', $thread)
                                    |
                                    {{-- trabaja con la ruta de editar la pregunta con autorización --}}
